import { c as createLucideIcon, r as reactExports, u as useControllableState, j as jsxRuntimeExports, a as composeEventHandlers, P as Primitive, b as useComposedRefs, d as createCollection, e as useDirection, f as useSize, g as createContextScope, h as cn, B as Button, E as EventType, i as useNavigate, k as PageLoader, X, S as Separator, C as CalendarDays, l as useSearch } from "./index-CtJ3C921.js";
import { B as Badge, M as MapPin, u as useShowtimes, a as useVenues } from "./useShowtimes-DAXYNdLs.js";
import { I as Input, L as Label } from "./label-Dizs-W2G.js";
import { c as clamp$1, u as usePrevious, S as Select, a as SelectTrigger, b as SelectValue, d as SelectContent, e as SelectItem } from "./select-D6-ZPUf5.js";
...
const Film = createLucideIcon("film", __iconNode$6);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function EventCard({
  ...
  const imageUrl = event.imageUrls[0] ?? EVENT_PLACEHOLDER_IMAGES[event.eventType];
  const isSelling = availableSeats !== void 0 && availableSeats < 20 && availableSeats > 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      "data-ocid": dataOcid,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[16/9] overflow-hidden bg-muted", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              ...
              onError: (e) => {
                e.target.src = "/assets/generated/event-other.dim_800x450.jpg";
              }
            }
          ),
          ...
          event.durationMinutes > 0n && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-2 right-2 bg-black/60 text-white text-xs px-2 py-1 rounded-md flex items-center gap-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-col flex-1 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground text-base line-clamp-2 leading-tight", children: event.title }),
            event.genre && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5 capitalize", children: event.genre })
          ] }),
          nextShowtime && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "w-3.5 h-3.5 shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: formatDate(nextShowtime.startTime) })
            ] }),
            nextShowtime.venueName && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-3.5 h-3.5 shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: nextShowtime.venueName })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between mt-auto pt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
            lowestPrice !== void 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-semibold text-foreground", children: [
              "Tickets from",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: formatPrice(lowestPrice) })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Price TBA" }),
            isSelling ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-destructive", children: "Selling fast" }) : availableSeats !== void 0 && availableSeats > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-emerald-600 dark:text-emerald-400", children: "Seats available" }) : availableSeats === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Sold out" }) : null
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-0.5 w-full bg-gradient-to-r from-primary/60 to-accent/60 rounded-full" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              "data-ocid": dataOcid ? `${dataOcid}.book_button` : "event_card.book_button",
              onClick: onBook,
              className: "w-full font-semibold transition-smooth",
              disabled: availableSeats === 0,
              children: availableSeats === 0 ? "Sold Out" : "Book Tickets"
            }
          )
        ] })
      ]
...
const DEMO_EVENTS = [
  ...
  },
  {
    ...
    description: "A journey through the musical eras of Taylor Swift's iconic discography, spanning over three hours of electrifying performance.",
  ...
  },
  {
    ...
    description: "Deep-dive into React 19, Server Components, and advanced patterns. Hands-on coding sessions with industry experts.",
  ...
  },
  {
    ...
    description: "The pinnacle of European club football. Two champions battle for the most prestigious trophy in the game.",
  ...
  },
  {
    ...
    eventType: EventType.concert,
    description: "Coldplay brings their spectacular Music of the Spheres World Tour, featuring their biggest hits and dazzling light shows.",
    imageUrls: ["/assets/generated/event-concert.dim_800x450.jpg"],
...
function getLowestPrice(event, showtimes) {
  const prices = showtimes.filter((s) => s.eventId === event.id).flatMap((s) => s.seatCategories.map((c) => c.priceInCents));
  if (prices.length === 0) return void 0;
  return prices.reduce((min, p) => p < min ? p : min, prices[0]);
}
function getTotalAvailable(event, showtimes) {
  const eventShowtimes = showtimes.filter((s) => s.eventId === event.id);
  if (eventShowtimes.length === 0) return void 0;
  return eventShowtimes.reduce(
    (sum, s) => sum + s.seatCategories.reduce((a, c) => a + Number(c.availableSeats), 0),
    0
  );
}
function getTotalBookings(event, showtimes) {
  return showtimes.filter((s) => s.eventId === event.id).reduce(
    (sum, s) => sum + s.seatCategories.reduce(
...
function getNextShowtime(event, showtimes) {
  return showtimes.filter((s) => s.eventId === event.id && s.isActive).sort((a, b) => Number(a.startTime - b.startTime))[0];
}
...
function useHomeSearchParams() {
  const raw = useSearch({ from: "/" });
  const navigate = useNavigate({ from: "/" });
  const params = {
    search: raw.q ?? "",
    type: raw.type ?? "all",
    sort: raw.sort ?? "date-asc",
  ...
  const setParams = (updates) => {
    ...
    void navigate({
      search: {
        q: next.search || void 0,
        type: next.type !== "all" ? next.type : void 0,
        sort: next.sort !== "date-asc" ? next.sort : void 0,
        dateFrom: next.dateFrom || void 0,
        dateTo: next.dateTo || void 0,
        minPrice: next.minPrice !== 0 ? next.minPrice : void 0,
        maxPrice: next.maxPrice !== 500 ? next.maxPrice : void 0,
        venueId: next.venueId !== "all" ? next.venueId : void 0
      },
      replace: true
    });
  };
...
function HomePage() {
  ...
  const events = backendEvents && backendEvents.length > 0 ? backendEvents : DEMO_EVENTS;
  const showtimes = backendShowtimes.length > 0 ? backendShowtimes : DEMO_SHOWTIMES;
  const venues = backendVenues.length > 0 ? backendVenues : DEMO_VENUES;
  const isUsingDemo = !backendEvents || backendEvents.length === 0;
  const allPrices = events.map((e) => getLowestPrice(e, showtimes)).filter(Boolean);
  const globalMaxPrice = allPrices.length > 0 ? Math.ceil(
    Number(allPrices.reduce((m, p) => p > m ? p : m, allPrices[0])) / 100
  ) : 500;
  const filtered = reactExports.useMemo(() => {
    ...
    if (filters.search) {
      ...
      list = list.filter(
        (e) => e.title.toLowerCase().includes(q) || e.genre.toLowerCase().includes(q) || e.description.toLowerCase().includes(q)
      );
    }
    if (filters.type !== "all") {
    ...
    if (filters.venueId !== "all") {
      ...
      list = list.filter(
        (e) => showtimes.some((s) => s.eventId === e.id && s.venueId === vid)
      );
    }
    if (filters.dateFrom) {
      ...
      if (from)
        list = list.filter(
          (e) => showtimes.some((s) => s.eventId === e.id && s.startTime >= from)
        );
    }
    if (filters.dateTo) {
      ...
      if (to)
        list = list.filter(
          (e) => showtimes.some(
            (s) => s.eventId === e.id && s.startTime <= to + 86400000000000n
          )
        );
    }
    ...
    switch (filters.sort) {
      case "date-asc":
        list.sort((a, b) => {
          var _a2, _b2;
          const sa = ((_a2 = getNextShowtime(a, showtimes)) == null ? void 0 : _a2.startTime) ?? 0n;
          const sb = ((_b2 = getNextShowtime(b, showtimes)) == null ? void 0 : _b2.startTime) ?? 0n;
          return Number(sa - sb);
        });
        break;
      case "date-desc":
      ...
      case "popularity":
        list.sort(
          (a, b) => getTotalBookings(b, showtimes) - getTotalBookings(a, showtimes)
        );
        break;
    }
    return list;
  }, [events, showtimes, filters]);
  const hasActiveFilters = filters.search || filters.type !== "all" || filters.venueId !== "all" || filters.dateFrom || filters.dateTo || filters.minPrice > 0 || filters.maxPrice < 500;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background flex-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          className: "max-w-2xl",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-3xl sm:text-4xl font-display font-bold text-foreground leading-tight", children: [
              "Discover & Book",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary block sm:inline sm:ml-2", children: "Movies & Events" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-3 text-base max-w-xl", children: "Browse upcoming shows, select your seats, and secure tickets instantly. From blockbusters to live concerts — all in one place." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Select,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: EVENT_TYPE_OPTIONS.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: opt.value, children: opt.label }, opt.value)) })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  ...
                  "Filters",
                  activeFilterCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-1.5 -right-1.5 w-5 h-5 rounded-full bg-primary text-primary-foreground text-[10px] font-bold flex items-center justify-center", children: activeFilterCount })
                ]
              }
            )
          ]
    ...
    showFilters && /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 py-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: "Date From" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: "Date To" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: "Venue" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Select,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      SelectTrigger,
                      {
                        ...
                        className: "h-9",
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-3.5 h-3.5 mr-1.5 text-muted-foreground" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "All Venues" })
                        ]
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", children: "All Venues" }),
                      venues.map((v) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: String(v.id), children: v.name }, String(v.id)))
                    ] })
                  ]
                }
              )
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-1 pt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Slider,
                {
          ...
          hasActiveFilters && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 py-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [
          ...
          isUsingDemo && /* @__PURE__ */ jsxRuntimeExports.jsx(
            Badge,
            {
              variant: "outline",
          ...
          filters.type !== "all" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Badge,
            {
              ...
              children: [
                (_a = EVENT_TYPE_OPTIONS.find((o) => o.value === filters.type)) == null ? void 0 : _a.label,
                /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-3 h-3" })
              ]
            }
          ),
          filters.venueId !== "all" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Badge,
            {
              ...
              children: [
                ((_b = venues.find((v) => String(v.id) === filters.venueId)) == null ? void 0 : _b.name) ?? "Venue",
                /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-3 h-3" })
              ]
            }
          )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 flex-wrap mb-7", children: EVENT_TYPE_OPTIONS.map((opt) => {
        const Icon = opt.icon;
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            className: `inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-medium transition-smooth border ${active ? "bg-primary text-primary-foreground border-primary shadow-interactive" : "bg-card text-muted-foreground border-border hover:border-primary/40 hover:text-foreground"}`,
            children: [
      ...
      filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        EmptyState,
        {
          ...
          description: hasActiveFilters ? "Try adjusting your search terms or clearing some filters." : "No events are available right now. Check back soon!",
        ...
        "div",
        {
          ...
          children: filtered.map((event, idx) => {
            const nextShowtime = getNextShowtime(event, showtimes);
            const venue = venues.find((v) => v.id === (nextShowtime == null ? void 0 : nextShowtime.venueId));
            return /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
